...
### MUST DO
- In Fabric scenarios: keep notebooks as orchestration entry points and place reusable Spark logic in Python modules/libraries.
...
### MUST NOT DO
- In Fabric scenarios: do not duplicate reusable transformation logic across multiple notebooks.
